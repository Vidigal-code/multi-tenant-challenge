    ...
    return (
        <>
            ...
            {isOpen && (
                <>
                    <div
                        className="fixed inset-0 z-[10003] bg-black/70 dark:bg-black/90 backdrop-blur-md
                    ...
                    >
                        <div className="p-6 relative h-full flex flex-col">
                            ...
                            <nav className="flex flex-col gap-2">
                                ...
                                >
                                    <div
                                        className="w-2 h-2 rounded-full bg-gray-900 dark:bg-gray-100 opacity-0
                                ...
                                {isAuth ? (
                                    <>
                                        ...
                                        <button
                                            ...
                                            duration-200 text-left font-semibold shadow-lg hover:shadow-xl hover:scale-[1.02]
                                            active:scale-[0.98] border border-gray-900 dark:border-white"
                                            type="button"
                                        >
                                            Sair
                                        </button>
