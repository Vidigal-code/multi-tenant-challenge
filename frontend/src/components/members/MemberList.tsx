...
export const MemberList = React.memo(function MemberList({
    ...
    return (
        <>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2 md:hidden">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            disabled={safePage === 1}
                            className="p-2 border border-gray-200 dark:border-gray-800 rounded-lg bg-white
                    ...
                    {pageMembers.map((m) => (
                        <tr
                            ...
                            className={`border-t border-gray-200 dark:border-gray-800 transition-colors ${
                                canClickMember ? 'cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-950 hover:border-gray-300 ' +
            ...
            {totalPages > 1 && (
                <div className="hidden md:flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t
