export const queryKeys = {
  ...
  invitesCreated: (page: number, pageSize: number) => ['invites-created', page, pageSize] as const,
  invitesReceived: (page: number, pageSize: number) => ['invites-received', page, pageSize] as const,
