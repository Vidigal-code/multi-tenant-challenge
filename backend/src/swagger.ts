    ...
    const cfg = new DocumentBuilder()
        ...
        .setDescription(
            [
                ...
                "Notifications API: broadcast messages to a company, deliver direct friend messages, reply to notifications, and track read status.",
                "Friendships: search users, send/accept/reject requests, remove friendships, and send targeted friend notifications.",
                "Realtime stack: WebSocket namespace /rt plus RabbitMQ workers that confirm delivery before persisting notifications.",
