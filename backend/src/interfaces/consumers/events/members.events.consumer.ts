...
class MembersEventsConsumer extends BaseResilientConsumer<any> {
     ...
     */
    private async forwardToRealtimeQueue(payload: any, eventId: string): Promise<void> {
        ...
        this.logger.rabbitmq(`Forwarded member event to ${NOTIFICATIONS_REALTIME_QUEUE}: ${eventId}`);
    }
