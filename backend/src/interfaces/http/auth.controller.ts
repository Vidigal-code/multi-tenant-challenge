...
import {AcceptInviteDto} from "@application/dto/accept-invite.dto";
...
export class AuthController {
    ...
    @HttpCode(200)
    @Post("accept-invite")
    @ApiOperation({summary: "Accept an invite and create/link user to company"})
    ...
    @UseGuards(JwtAuthGuard)
    @ApiOperation({summary: "List companies where user is primary owner (creator)"})
        ...
        schema: {
            ...
            properties: {
                deleteCompanyIds: {
                    type: "array",
                    items: {type: "string"},
                    description: "Array of company IDs to delete. Required if user is primary owner of companies.",
                },
            },
        },
        required: false,
