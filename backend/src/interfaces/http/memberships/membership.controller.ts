...
@ApiTags("membership")
@ApiCookieAuth()
@Controller("companys/:companyId/members")
...
export class MembershipController {
  ...
  @Get()
  @ApiOperation({ summary: "List members of companys" })
  ...
  async listMembers(
    ...
    const currentUserMembership =
      await this.membershipRepository.findByUserAndCompany(user.sub, companyId);
  ...
  @Get("role")
  @ApiOperation({ summary: "Get current users role within companys" })
  ...
  @ApiOperation({ summary: "Remove a member from companys" })
  @ApiResponse({ status: 200, description: "Member removed" })
  @ApiResponse({
    status: 403,
    description: "Insufficient role or invariant violations",
    type: ErrorResponse,
  })
  @ApiResponse({
    status: 404,
  ...
  @Roles(Role.OWNER)
  @ApiOperation({ summary: "Transfer companys ownership to another member" })
  ...
  @Get("primary-owner")
  @ApiOperation({ summary: "Get primary owner (creator) of companys" })
