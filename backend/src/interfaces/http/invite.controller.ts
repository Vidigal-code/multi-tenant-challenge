...
import {InviteCreatedResponse, InviteDto} from "@application/dto/invite.dto";
...
@ApiTags("invite")
@ApiCookieAuth()
@Controller("company/:companyId/invite")
...
export class InviteController {
    ...
    @ApiOperation({summary: "Invite a user to company"})
    @ApiResponse({status: 201, description: "Invite created", type: InviteCreatedResponse})
    @ApiResponse({status: 400, description: "Invalid invite data", type: ErrorResponse})
