...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (notificationRepo, domainEvents) =>
        new MarkNotificationReadUseCase(notificationRepo, domainEvents),
    ...
    },
    {
      ...
      useFactory: (notificationRepo) =>
        new DeleteNotificationsUseCase(notificationRepo),
      inject: [NOTIFICATION_REPOSITORY],
    },
    {
      provide: ReplyToNotificationUseCase,
      useFactory: (notificationRepo, domainEvents, userRepo) =>
        new ReplyToNotificationUseCase(
          notificationRepo,
          domainEvents,
          userRepo,
        ),
