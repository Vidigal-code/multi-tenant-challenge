...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (companyRepo, membershipRepo) =>
        new GetCompanyUseCase(companyRepo, membershipRepo),
      inject: [COMPANY_REPOSITORY, MEMBERSHIP_REPOSITORY],
    },
    {
      provide: UpdateCompanyUseCase,
      useFactory: (companyRepo, membershipRepo) =>
        new UpdateCompanyUseCase(companyRepo, membershipRepo),
      inject: [COMPANY_REPOSITORY, MEMBERSHIP_REPOSITORY],
    },
    {
      provide: DeleteCompanyUseCase,
      useFactory: (companyRepo, membershipRepo, userRepo) =>
        new DeleteCompanyUseCase(companyRepo, membershipRepo, userRepo),
