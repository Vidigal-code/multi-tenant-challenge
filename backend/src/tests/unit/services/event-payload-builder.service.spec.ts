...
import {InMemoryUserRepository, InMemoryCompanyRepository} from "../../support/in-memory-repositories";
...
describe("EventPayloadBuilderService", () => {
    ...
    beforeEach(() => {
        ...
        service = new EventPayloadBuilderService(userRepo as any, companyRepo as any, configService);
    });
