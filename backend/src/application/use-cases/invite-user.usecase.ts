...
export class InviteUserUseCase {
    ...
    async execute(input: InviteUserInput): Promise<{ invite: Invite }> {
        ...
        // Verificar se já existe um convite ativo - se existir, createOrReuse vai reutilizá-lo
        // Não precisamos lançar erro aqui, pois createOrReuse já lida com a reutilização
