...
export class MemberCompanyDto {
    ...
    @ApiProperty({example: 'ADMIN', description: 'User role in the company', enum: ['OWNER', 'ADMIN', 'MEMBER']})
...
export class MemberCompaniesResponseDto {
    @ApiProperty({type: [MemberCompanyDto], description: 'List of companies where user is a member'})
    data!: MemberCompanyDto[];
